...
interface ArrowSlickProps {
    currentSlide?: any, slideCount?: any

}

export const SlickArrowLeft = ({ currentSlide, slideCount, ...props }: ArrowSlickProps) => (
    <div
        {...props}
...
export const SlickArrowRight = ({ currentSlide, slideCount, ...props }: ArrowSlickProps) => (
    <div
        {...props}
